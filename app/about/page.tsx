    ...
    <main className="w-full min-h-screen py-12 px-4">
      <div className="max-w-3xl w-full mx-auto">
        ...
        <div className="space-y-6">
          ...
          <Card className="bg-card border border-border">
            <CardBody className="p-8">
              <h2 className="text-2xl font-bold text-foreground mb-4">Multilingual & Culturally Aware</h2>
              <p className="text-muted-foreground mb-4">
          ...
          <Card className="bg-card border border-border">
            <CardBody className="p-8">
              <h2 className="text-2xl font-bold text-foreground mb-4">What OyaTalk Can Do</h2>
              <p className="text-muted-foreground mb-4">
          ...
          <Card className="bg-card border border-border">
            <CardBody className="p-8">
              <h2 className="text-2xl font-bold text-foreground mb-4">Powered by ElevenLabs</h2>
              <p className="text-muted-foreground">
          ...
          <Card className="bg-card border border-border">
            <CardBody className="p-8">
              <h2 className="text-2xl font-bold text-foreground mb-4">The NaijaPrompt Ecosystem</h2>
              <p className="text-muted-foreground mb-4">
