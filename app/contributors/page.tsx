        ...
        <div className="space-y-6">
          <Card className="bg-white border border-gray-200">
            <CardBody className="p-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">Why Contribute?</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-700">Verified facts about people, places, and events across Nigeria and Africa</p>
                  </div>
                </div>
                <div className="flex gap-3">
          ...
          <Card className="bg-white border border-gray-200">
            <CardBody className="p-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button 
                  className="border-2 border-gray-900 text-gray-900 font-medium px-6 bg-white" 
                  radius="full"
                  variant="bordered"
                >
                  Contact the Team
